...
object ReportBuilder {
    ...
    fun buildTextReport(
        ...
        return buildString {
            ...
            appendLine("- Stock return mean: ${scenario.market.stockMeanReturn.percent()}")
            appendLine("- Stock return volatility: ${scenario.market.stockStdDev.percent()}")
            appendLine("- Bond return mean: ${scenario.market.bondMeanReturn.percent()}")
            appendLine("- Bond return volatility: ${scenario.market.bondStdDev.percent()}")
