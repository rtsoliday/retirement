...
This is draft copy for closed testing and release prep. Review final wording before public submission, especially any financial-feature declarations.
...
Recommended first screenshot sequence:
...
- "Stress-test your retirement target."
- "Compare the decisions that change your odds."
- "See the assumptions behind every result."
- "Keep planning data local unless you export it."
- "Share reports when your assumptions are ready."

## Feature Graphic Direction

Use the current app icon artwork as the visual anchor: cream background, navy magnifying glass, growth bars, retirement landscape, green hills, white path, and gold sun.

Recommended headline:

Retirement decisions, stress-tested privately.

Recommended supporting line:

Compare retirement age, spending, Social Security, healthcare, taxes, and market risk on-device.
...
Potential tags/keywords for copy planning:
...
## Policy-Sensitive Claims To Avoid
...
- Confirm final app name and icon.
- Confirm package name and signing identity.
- Verify the privacy policy URL.
- Verify data safety answers match the actual implementation.
- Verify financial feature declarations for the current Play Console flow.
- Confirm screenshots come from a release or release-candidate build.
- Confirm all store copy avoids guarantee/advice language.
